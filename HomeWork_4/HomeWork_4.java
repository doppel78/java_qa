package GeekBrains_Java_QA.HomeWork_4;
...
public class HomeWork_4 {
    ...
    private static void dividedArray() {
        ...
        Thread thread1 = new Thread(new HomeWork_4.ThreadedArray(a1, 1));
        Thread thread2 = new Thread(new HomeWork_4.ThreadedArray(a2, 2));
